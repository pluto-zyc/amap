...
// 请求 (坐下右上)确定中心点
export const requestCenterMarker = () => axios({
    url: baseUrl + '/api/data/json/leftdownRightup',
    method: "get",
    })

// 请求 国市县控站
export const requestCountryMarker = () => axios({
    url: baseUrl + '/api/data/excel/station',
    method: "get",
    })
